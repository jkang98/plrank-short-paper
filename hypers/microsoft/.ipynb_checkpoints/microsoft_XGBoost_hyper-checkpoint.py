...
x_train, y_train = load_svmlight_file("MSLR-WEB30K/Fold"+str(fold_num)+"/Fold"+str(fold_num)+".train")
x_valid, y_valid = load_svmlight_file("MSLR-WEB30K/Fold"+str(fold_num)+"/Fold"+str(fold_num)+".vali")
x_test, y_test = load_svmlight_file("MSLR-WEB30K/Fold"+str(fold_num)+"/Fold"+str(fold_num)+".test")

group_train = []
with open("MSLR-WEB30K/Fold"+str(fold_num)+"/Fold"+str(fold_num)+".train.group", "r") as f:
    data = f.readlines()
    for line in data:
        group_train.append(int(line.split("\n")[0]))

group_valid = []
with open("MSLR-WEB30K/Fold"+str(fold_num)+"/Fold"+str(fold_num)+".vali.group", "r") as f:
    data = f.readlines()
    for line in data:
        group_valid.append(int(line.split("\n")[0]))

group_test = []
with open("MSLR-WEB30K/Fold"+str(fold_num)+"/Fold"+str(fold_num)+".test.group", "r") as f:
    data = f.readlines()
    for line in data:
